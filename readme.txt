...
* **Thumbnail Images.** Choose to show featured image, or the oldest image attached to a post is shown by default.
...
If you get the above message and possibly the following:
Parse error: syntax error, unexpected T_FUNCTION in [plugin location] on line [number], you may need to update your PHP version to 5.3 or above. Contact your web host, or search their FAQ.
...
* Added the option to display featured images.

== Upgrade Notice ==

= 1.1.0 = 
You can now choose to display featured images.